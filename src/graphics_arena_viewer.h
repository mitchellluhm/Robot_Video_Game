...
class GraphicsArenaViewer : public GraphicsApp {
 public:
   ...
   *
   * This will cause the user to start a new game.
   * All entities, lives, etc. will be reset to default values.
   * Entity positions will be randomized again.
   */
  ...
  /**
   * @brief See if the state of the game is paused.
   */
  bool IsPaused() { return paused_; }

  /**
   * @brief change general graphics options that are common to all games.
   * Currently just sets play button to "Start Game" and sets paused_ to true.
   */
  void ResetCommonGraphics();
