...
class MotionHandler {
 public:
  ...
  explicit MotionHandler(ArenaMobileEntity * ent)
    ...
    // Use the ROBOT_SPEED_DELTA parameter to set the speed
    // Will robot be only ArenaMobileEntity ???
    set_speed_delta(ROBOT_SPEED_DELTA);
    set_angle_delta(ROBOT_ANGLE_DELTA);
  }
